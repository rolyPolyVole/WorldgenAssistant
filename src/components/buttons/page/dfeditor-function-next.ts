...
export default {
    ...
    async execute(interaction, client) {
        ...
        const menuPages = (PageSystem.from(user as string, PageSystemNamespaces.BROWSE_OPERATORS) as PageSystem<SelectMenuComponentOptionData>).nextPage();
